...
import { driversComoFuncionaSteps } from "@/lib/data";
import { cn } from "@/lib/utils";

const STEP_DELAY_MS = 320;
const LINE_DURATION_MS = 1400;

export function DriversComoFuncionaSection() {
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div ref={sectionRef} className="relative">
          ...
          <div className="grid gap-10 md:grid-cols-4 md:gap-6">
            {driversComoFuncionaSteps.map((step, index) => {
              ...
              return (
                ...
                >
                  ...
                  {index < driversComoFuncionaSteps.length - 1 && (
                    <ArrowRight
                      className={cn(
