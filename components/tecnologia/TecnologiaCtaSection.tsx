...
import { tecnologiaCta } from "@/lib/data";
    ...
    <section className="relative">
      ...
      <div className="relative z-10 px-6 pb-20 md:px-10 md:pb-28">
        <div className="relative mx-auto max-w-4xl rounded-[58px] bg-brand-black px-8 pb-12 pt-12 text-center md:px-16">
          <div className="absolute -top-12 left-1/2 flex h-24 w-24 -translate-x-1/2 items-center justify-center rounded-full bg-brand-yellow md:-top-16">
            <Cpu className="h-9 w-9 text-brand-black" />
          </div>

          <h2 className="mb-10 mt-4 text-2xl font-bold leading-tight text-white md:mt-5 md:text-3xl lg:text-4xl">
            {tecnologiaCta.heading}
          </h2>

          <Link
            href={tecnologiaCta.href}
            target="_blank"
